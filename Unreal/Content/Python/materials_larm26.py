"""Build the dedicated pass-26 Larmgatan materials with normal and roughness maps."""
...
for name,spec in MAN['materials'].items():
 if not name.startswith('M_Larm26_'):continue
...
(R/'previews/larm26-materials.json').write_text(json.dumps({'status':'passed','materials':report},indent=2))
