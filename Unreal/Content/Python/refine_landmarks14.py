...
try:
 ...
 prefixes=tuple(json.loads((R/'previews/landmarks14-build.json').read_text())['changed'])
 ...
 for spec in selected:
  ...
  (R/'previews/landmarks14-refine-import.json').write_text(json.dumps(report,indent=2))
 ...
 report['status']='failed';report['error']=traceback.format_exc();(R/'previews/landmarks14-refine-import.json').write_text(json.dumps(report,indent=2));raise
