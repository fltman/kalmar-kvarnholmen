...
ionic_only=False
try:
 for name in [k for k in MAN['materials'] if k.startswith(('M_Kvarnholmen_','M_Sodra_','M_Landmark_'))]:
 ...
 prefixes=tuple(json.loads((R/'previews/kvarnholmen-build.json').read_text())['changed'])
 ...
 for spec in selected:
  ...
  desired_nanite=not (name.startswith('SM_Kvarnholmen_') or name=='SM_Building_91846951')
  ...
  (R/'previews/kvarnholmen-import.json').write_text(json.dumps(report,indent=2))
 for spec in MAN['cameras']:
  if not spec['name'].startswith(('46_','47_','48_','49_','50_','51_','52_','53_','54_','55_','56_','57_','58_','59_','60_','61_','62_','63_','64_','65_','66_','67_','68_')):continue
