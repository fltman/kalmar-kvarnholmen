"""Assign twelve dedicated surface materials to the northern street facades."""
...
for name,spec in MAN['materials'].items():
 if not name.startswith('M_Street21_'):continue
...
(R/'previews/street21-materials.json').write_text(json.dumps({'status':'passed','materials':report},indent=2))
