"""Build eight dedicated pass-22 surface materials with normal and roughness maps."""
...
for name,spec in MAN['materials'].items():
 if not name.startswith('M_Street22_'):continue
...
(R/'previews/street22-materials.json').write_text(json.dumps({'status':'passed','materials':report},indent=2))
