...
try:
 ...
 prefixes=('SM_Storgatan_Frimurarehotellet',)
 ...
 for spec in selected:
  ...
  (R/'previews/storgatan-final-import.json').write_text(json.dumps(report,indent=2))
 ...
 report['status']='failed';report['error']=traceback.format_exc();(R/'previews/storgatan-final-import.json').write_text(json.dumps(report,indent=2));raise
