...
try:
 ...
 prefixes=('SM_Storgatan_Frimurarehotellet','SM_Building_91846938','SM_Building_91264999')
 ...
 for spec in selected:
  ...
  (R/'previews/larmtorget-facades-final-import.json').write_text(json.dumps(report,indent=2))
 ...
 report['status']='failed';report['error']=traceback.format_exc();(R/'previews/larmtorget-facades-final-import.json').write_text(json.dumps(report,indent=2));raise
