...
R=Path(__file__).resolve().parents[3];route=json.loads((R/'source/pass18-walk.json').read_text())
...
def write():(R/'previews/pass18-pie-walk.json').write_text(json.dumps(report,indent=2))
def finish():
