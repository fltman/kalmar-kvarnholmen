...
try:
 ...
 prefixes=('SM_Storgatan_Kalmar_Teater','SM_Storgatan_Frimurarehotellet','SM_Storgatan_Paving','SM_Storgatan_Trees')
 ...
 for spec in selected:
  ...
  (R/'previews/storgatan-refine-import.json').write_text(json.dumps(report,indent=2))
 for spec in MAN['cameras']:
  if not spec['name'].startswith(('34_','35_','36_','37_','38_','39_','40_')):continue
 ...
 report['status']='failed';report['error']=traceback.format_exc();(R/'previews/storgatan-refine-import.json').write_text(json.dumps(report,indent=2));raise
