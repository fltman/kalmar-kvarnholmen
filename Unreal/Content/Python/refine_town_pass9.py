...
try:
 ...
 for spec in selected:
  ...
  (R/'previews/town-pass9-refine-import.json').write_text(json.dumps(report,indent=2))
 ...
 report['status']='failed';report['error']=traceback.format_exc();(R/'previews/town-pass9-refine-import.json').write_text(json.dumps(report,indent=2));raise
