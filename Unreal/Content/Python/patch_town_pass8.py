...
ionic_only=False
try:
 for name in [n for n in MAN['materials'] if n.startswith('M_Town_')]:
 ...
 prefixes=tuple(json.loads((R/'previews/town-pass8-build.json').read_text())['updated'])
 ...
 for spec in selected:
  ...
  (R/'previews/town-pass8-import.json').write_text(json.dumps(report,indent=2))
 for spec in MAN['cameras']:
  if not spec['name'].startswith(('23_','24_','25_','26_','27_')):continue
 ...
 (R/'previews/hero-review-request.json').write_text(json.dumps({'shots':[['23_Radhus_Fasad','44_Unreal_Radhuset.png'],['24_Sodra_Husraden','45_Unreal_South_Houses.png'],['25_Stadshotell','46_Unreal_Stadshotell.png'],['26_Nelsonska','47_Unreal_Nelsonska.png'],['27_Vastra_Husraden','48_Unreal_West_Houses.png']]}))
except Exception:
 report['status']='failed';report['error']=traceback.format_exc();(R/'previews/town-pass8-import.json').write_text(json.dumps(report,indent=2));raise
