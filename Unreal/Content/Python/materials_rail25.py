"""Build the dedicated pass-25 railway materials with normal and roughness maps."""
...
for name,spec in MAN['materials'].items():
 if not name.startswith('M_Rail25_'):continue
...
(R/'previews/rail25-materials.json').write_text(json.dumps({'status':'passed','materials':report},indent=2))
