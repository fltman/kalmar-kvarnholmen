...
try:
 ...
 prefixes=('SM_Domkyrka_Pulpit_Support',)
 ...
 for spec in selected:
  ...
  (R/'previews/pulpit-support-import.json').write_text(json.dumps(report,indent=2))
 ...
 (R/'previews/hero-review-request.json').write_text(json.dumps({'fixture_validation':True,'shots':[['16_Predikstol_Infästning','36_Unreal_Pulpit_Mounted.png']]}))
except Exception:
 report['status']='failed';report['error']=traceback.format_exc();(R/'previews/pulpit-support-import.json').write_text(json.dumps(report,indent=2));raise
