"""Build the dedicated pass-24 station surface materials with normal and roughness maps."""
...
for name,spec in MAN['materials'].items():
 if not name.startswith('M_Station24_'):continue
...
(R/'previews/station24-materials.json').write_text(json.dumps({'status':'passed','materials':report},indent=2))
