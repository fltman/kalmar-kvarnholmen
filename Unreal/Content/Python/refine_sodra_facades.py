...
try:
 ...
 for spec in selected:
  ...
  (R/'previews/sodra-facades-refine-import.json').write_text(json.dumps(report,indent=2))
 ...
 report['status']='failed';report['error']=traceback.format_exc();(R/'previews/sodra-facades-refine-import.json').write_text(json.dumps(report,indent=2));raise


import runpy
runpy.run_path(str(R/'Unreal/Content/Python/check_sodra_facades.py'))
