...
ionic_only=False
try:
 for name in ['M_Town_TileRed','M_Town_TileDark']:
 ...
 for spec in selected:
  ...
  (R/'previews/town-pass8-final-import.json').write_text(json.dumps(report,indent=2))
 ...
 report['status']='failed';report['error']=traceback.format_exc();(R/'previews/town-pass8-final-import.json').write_text(json.dumps(report,indent=2));raise
