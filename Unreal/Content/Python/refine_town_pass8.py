...
try:
 ...
 prefixes=('SM_Radhuset','SM_Calmar_Stadshotell','SM_Building_91926317','SM_Building_91846964','SM_Building_92412842','SM_Building_92412870')
 ...
 for spec in selected:
  ...
  (R/'previews/town-pass8-refine-import.json').write_text(json.dumps(report,indent=2))
 ...
 report['status']='failed';report['error']=traceback.format_exc();(R/'previews/town-pass8-refine-import.json').write_text(json.dumps(report,indent=2));raise
