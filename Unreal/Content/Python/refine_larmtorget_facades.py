...
try:
 ...
 for spec in selected:
  ...
  (R/'previews/larmtorget-facades-refine-import.json').write_text(json.dumps(report,indent=2))
 ...
 report['status']='failed';report['error']=traceback.format_exc();(R/'previews/larmtorget-facades-refine-import.json').write_text(json.dumps(report,indent=2));raise
