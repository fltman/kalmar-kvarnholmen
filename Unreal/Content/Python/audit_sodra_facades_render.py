...
names=json.loads((R/'previews/sodra-facades-build.json').read_text())['changed']
for name in names:
...
(R/'previews/sodra-facades-render-audit.json').write_text(json.dumps(report,indent=2))
