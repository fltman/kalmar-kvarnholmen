"""Build the dedicated pass-23 Baronen surface materials with normal and roughness maps."""
...
for name,spec in MAN['materials'].items():
 if not name.startswith('M_Baronen23_'):continue
...
(R/'previews/baronen23-materials.json').write_text(json.dumps({'status':'passed','materials':report},indent=2))
