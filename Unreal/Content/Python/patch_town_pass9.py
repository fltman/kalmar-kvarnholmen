...
try:
 ...
 prefixes=tuple(json.loads((R/'previews/town-pass9-scope.json').read_text())['changed'])
 ...
 for spec in selected:
  ...
  (R/'previews/town-pass9-import.json').write_text(json.dumps(report,indent=2))
 for spec in MAN['cameras']:
  if not spec['name'].startswith(('28_','29_','30_','31_','32_','33_')):continue
 ...
 (R/'previews/hero-review-request.json').write_text(json.dumps({'shots':[['25_Stadshotell','49_Unreal_Hotel_Pass9.png'],['28_Hotellportal','50_Unreal_Hotel_Portal.png'],['29_Hotelltorn','51_Unreal_Hotel_Tower.png'],['30_Radmannen_Port','52_Unreal_Radmannen_Portal.png'],['31_Hotell_Snickeri','53_Unreal_Hotel_Windows.png']]}))
except Exception:
 report['status']='failed';report['error']=traceback.format_exc();(R/'previews/town-pass9-import.json').write_text(json.dumps(report,indent=2));raise
