...
ionic_only=False
try:
 for name in ['M_Church_Copper','M_Church_Roof','M_Church_Pier_Stone','M_Church_Urn']:
 ...
 prefixes=('SM_Kalmar_Domkyrka','SM_Domkyrka_Exterior_Details')
 ...
 for spec in selected:
  ...
  (R/'previews/exterior-pass7-import.json').write_text(json.dumps(report,indent=2))
 for spec in MAN['cameras']:
  if not spec['name'].startswith(('20_','21_','22_')):continue
 ...
 (R/'previews/hero-review-request.json').write_text(json.dumps({'shots':[['22_Sydfasad','40_Unreal_South_Facade.png'],['20_Sydportal','41_Unreal_South_Portal.png'],['21_Fasad_Stenverk','42_Unreal_Stonework.png'],['19_Tornhuv','43_Unreal_Copper_Pass7.png']]}))
except Exception:
 report['status']='failed';report['error']=traceback.format_exc();(R/'previews/exterior-pass7-import.json').write_text(json.dumps(report,indent=2));raise
