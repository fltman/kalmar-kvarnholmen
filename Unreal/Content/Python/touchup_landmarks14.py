...
ionic_only=False
try:
 for name in [n for n in MAN['materials'] if n.startswith('M_Landmark_')]:
 ...
 prefixes=tuple(json.loads((R/'previews/landmarks14-touchup-build.json').read_text())['changed'])
 ...
 for spec in selected:
  ...
  (R/'previews/landmarks14-touchup-import.json').write_text(json.dumps(report,indent=2))
 ...
 report['status']='failed';report['error']=traceback.format_exc();(R/'previews/landmarks14-touchup-import.json').write_text(json.dumps(report,indent=2));raise


exec(compile((R/'Unreal/Content/Python/check_landmarks14.py').read_text(),str(R/'Unreal/Content/Python/check_landmarks14.py'),'exec'),{'__file__':str(R/'Unreal/Content/Python/check_landmarks14.py')})

if all(json.loads((R/'previews'/f).read_text())['status']=='passed' for f in ['landmarks14-gates.json','landmarks14-collision.json']):
 exec(compile((R/'Unreal/Content/Python/walk_landmarks14.py').read_text(),str(R/'Unreal/Content/Python/walk_landmarks14.py'),'exec'),{'__file__':str(R/'Unreal/Content/Python/walk_landmarks14.py')})
