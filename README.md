...
- Individually developed landmarks including Gerdas / Castenska gården, the mill complex, old bathhouse, old fire station, city gates, waterfront buildings, the Kalmar C station house, and Kalmar slott on its island.
...
The earlier correction pass distinguishes Riskvarnen from Ångkvarnen, replaces Gerdas' generic frontage, separates the overlapping Stortorget frontages, restores Barometern's entrance, articulates Witt's rear, and adds mapped green and parking surfaces. The [portal detail pass](docs/REFINEMENT_19.md) improves Gerdas’ carved portal and timber door, and Varmbadhuset’s gables, copper caps and entrance. The [first street pass](docs/REFINEMENT_20.md) refines six houses, including Kullzénska and Areskogska at the Norra Långgatan corners, plus Storgatan shopfronts and glass oriels. The [northern street pass](docs/REFINEMENT_21.md) adds seven individually authored facades and wings, including the Köpmantorget passage and Gallerian’s north entrance. The [Kaggensgatan and Larmgatan pass](docs/REFINEMENT_22.md) refines four more buildings and wings toward Fiskaregatan, including brickwork, projecting windows and recessed shops. The latest passes add the [Baronen shopping centre](docs/REFINEMENT_23.md) at Ölandshamnen, the [Kalmar C station house](docs/REFINEMENT_24.md) with its corner tower and canopy, the station's [tracks and platforms](docs/REFINEMENT_25.md) with signals, overhead line and a level crossing, [five buildings on Larmgatan](docs/REFINEMENT_26.md) by the station, among them the bank with its clock lantern and the Odd Fellows house, and [Kalmar slott](docs/REFINEMENT_27.md) with its ramparts, dry moat, bridge and ravelin on Slottsholmen. See [known limitations](docs/KNOWN_ISSUES.md).
