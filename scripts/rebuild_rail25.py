...
exec(compile((R/'scripts/build_rail25.py').read_text(),'build_rail25.py','exec'))
extension_names=rail25_names;extension_cameras=rail25_cameras
tail=(R/'scripts/rebuild_polish15.py').read_text();tail=tail[tail.index("exec(compile((R/'scripts/district_tangent_export.py')"):];tail=tail.replace('polish15-build.json','rail25-build.json').replace('POLISH15_BUILD_OK','RAIL25_BUILD_OK')
exec(compile(tail,'export_rail25','exec'))
