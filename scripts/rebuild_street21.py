...
extension_names=street21_names;extension_cameras=street21_cameras
tail=(R/'scripts/rebuild_polish15.py').read_text();tail=tail[tail.index("exec(compile((R/'scripts/district_tangent_export.py')"):];tail=tail.replace('polish15-build.json','street21-build.json').replace('POLISH15_BUILD_OK','STREET21_BUILD_OK')
exec(compile(tail,'export_street21','exec'))
