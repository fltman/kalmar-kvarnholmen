...
for name in json.loads((R/'previews/sodra-facades-build.json').read_text())['changed']:
 ...
 result[name]=item
(R/'previews/sodra-facades-fbx-audit.json').write_text(json.dumps(result,indent=2))
