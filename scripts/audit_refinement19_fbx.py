...
for name in json.loads((R/'previews/refinement19-build.json').read_text())['changed']:
 ...
 result[name]=item
(R/'previews/refinement19-fbx-audit.json').write_text(json.dumps(result,indent=2))
