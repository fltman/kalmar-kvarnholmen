...
extension_names=larm26_names;extension_cameras=larm26_cameras
tail=(R/'scripts/rebuild_polish15.py').read_text();tail=tail[tail.index("exec(compile((R/'scripts/district_tangent_export.py')"):];tail=tail.replace('polish15-build.json','larm26-build.json').replace('POLISH15_BUILD_OK','LARM26_BUILD_OK')
exec(compile(tail,'export_larm26','exec'))
