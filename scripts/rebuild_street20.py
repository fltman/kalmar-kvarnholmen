...
extension_names=street20_names;extension_cameras=street20_cameras
tail=(R/'scripts/rebuild_polish15.py').read_text();tail=tail[tail.index("exec(compile((R/'scripts/district_tangent_export.py')"):];tail=tail.replace('polish15-build.json','street20-build.json').replace('POLISH15_BUILD_OK','STREET20_BUILD_OK')
exec(compile(tail,'export_street20','exec'))
