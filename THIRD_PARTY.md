...
`T_Street22Clinker_*` are original procedural brick colour, roughness and normal maps generated by `scripts/make_street22_textures.py`, covered by CC BY 4.0. They interpret a basket-bond surface and contain no reference-photo pixels.

`T_Baronen23Profiled_*` (white trapezoidal cladding) and `T_Baronen23Brick_*` (orange-red machine brick in cross bond), generated by `scripts/make_baronen23_textures.py`, `T_Station24Slate_*` (rhombic slates), generated by `scripts/make_station24_textures.py`, and `T_Rail25Ballast_*`, `T_Rail25Tactile_*`, `T_Rail25Warning_*` and `T_Rail25Timber_*` (crushed granite ballast, ribbed guidance tiles, studded warning tiles and weathered sleeper timber), generated by `scripts/make_rail25_textures.py`, are original procedural colour, roughness and normal maps covered by CC BY 4.0. They contain no reference-photo pixels.

## Lettering

The lettering BARONEN, 1874, 1910 and Kalmar C is mesh geometry generated from Blender's built-in text font, which in Blender 5.2 is Inter (SIL Open Font License 1.1). No font file is redistributed.
